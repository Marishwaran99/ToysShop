      ...
      ;}));
        ...
        margin: EdgeInsets.symmetric(horizontal:16, vertical:8),
          child:Row(children: <Widget>[
            ...
            height:150,decoration: BoxDecoration(image:DecorationImage(fit: BoxFit.cover, image: NetworkImage(_product.thumbnailImage)) ),
          ), 
          SizedBox(width:8),
          Column(
            ...
            children:<Widget>[
              ...
              InSectionSpacing(),
              FlatButton(onPressed: (){},color:Colors.black87,textColor: Colors.white, child: Text('Add to Cart')),
