...
class MyAppBar extends StatelessWidget implements PreferredSizeWidget{
  ...
  Widget build(BuildContext context) {
    return AppBar(
      ...
      },child:IconButton(onPressed: (){back ? Navigator.pop(context) : log('drawer');}, icon: back ? Icon(Icons.chevron_left, color: Colors.black87,): Icon(Icons.menu, color: custom.titleTextColor))),
      title:
